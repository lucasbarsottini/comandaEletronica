        ...
        <main class="principal">
            <section class="container__principal">
                ...
                <div class="principal__cardapio__item">
                    ...
                    <p class="cardapio__texto"> <a class="cardapio__link" href="/section" id =""> Lanches </a></p>
                </div>
                <hr>
                <div class="principal__cardapio__item">
                    <img src="<?php echo e(asset('img/bebidas.png')); ?>" class="cardapio__imagem">
                    <p class="cardapio__texto"><a class="cardapio__link" href="<?php echo e(route('categorias.bebidas')); ?>" id ="">Bebidas</a></p>
                </div>
                <hr>
                <div class="principal__cardapio__item">
                    <img src="<?php echo e(asset('img/sobremesas.png')); ?>" class="cardapio__imagem">
                    <p class="cardapio__texto"><a class="cardapio__link" id ="" href="<?php echo e(route('categorias.sobremesas')); ?>">Sobremesas</a></p>
                </div>
                <hr>
...
<?php /**PATH C:\xampp\htdocs\projetoTCC\resources\views/listaprodutos.blade.php ENDPATH**/ ?>