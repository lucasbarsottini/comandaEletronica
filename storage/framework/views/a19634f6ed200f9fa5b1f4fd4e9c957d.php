        ...
        $('.botao_confirmacao').on('click', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    window.location.href = '<?php echo e(route("comandas.ativas")); ?>';
                },
        ...
        <main class="principal">
            ...
            <section class="container__principal">
               ...
               <div class="principal__itens">
                ...
                <p class="itens__texto"><?php echo e($item->produto->nome); ?> : <?php echo e($item->quantidade); ?> x</p>
                ...
                <div class="valor_container">
                    <p class="valor_total">R$<?php echo e($valorTotal); ?></p>
                </div>
               </div>
...
<?php /**PATH C:\xampp\htdocs\projetoTCC\resources\views/fechamento.blade.php ENDPATH**/ ?>